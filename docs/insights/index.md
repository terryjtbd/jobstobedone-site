...
这里汇集公众号「JTBD商业创新实验室」已发布的内容，分为作者原创与经典解读两个持续更新的栏目。经典解读明确标注原作者、原始访谈或出处，与 Terry 原创文章区分呈现。
...
> 根据经典 JTBD 研究、公开文章与访谈整理。每篇均标明原作者、原始访谈或出处；此栏目将持续更新。

### [Bob Moesta 谈待办任务（上）：先理解客户为什么转换](./bob-moesta-jtbd-part-1)

*根据 Bob Moesta 与 Des Traynor 的访谈整理，重建客户从忍受现状到发生转换的完整时间线。*

### [Bob Moesta 谈待办任务（下）：把客户转换变成产品与增长](./bob-moesta-jtbd-part-2)

*讨论如何从场景与期望进步出发，把客户转换洞察连接到产品、营销与增长。*
